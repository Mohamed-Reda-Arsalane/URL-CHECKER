//Initializing global variables and adding event listener
...
//Checks the format of the entered string to see if it matches with the url format using regular expression.
...
var lastDate = 0;
//check if the url exists by sending it to the server
async function checkexistence() {
  ...
  */
    ...
    //Always returning that the url exists and that it is a file as I am only mocking the conection to the server
  } else {
    console.log("can't talk with server yet");
    return -1;
  }
}
